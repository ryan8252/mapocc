...
# BEVFusion / MAESTRO map-protocol aligned version of the strongest current
# MTL map-side stack:
#   HFM adapter + per-scale residual adapter + FPN lateral ASPP
#   + focal-Dice weighted map loss + active enhancement gate.
#
# Geometry:
...
#
# This keeps the native strong config intact and changes only the parity grid.
...
# Depth/PV auxiliary supervision stays in the original 40m crop. Only the BEV
# feature canvas and map raster/eval grid are widened for map parity.
grid_config = {
    'x': [-40, 40, 0.4],
    'y': [-40, 40, 0.4],
    'z': [-1, 5.4, 6.4],
