...
# Paper-parity benchmark for MAESTRO / BEVFusion map evaluation.
#
# Geometry:
...
#
# This is intentionally separate from the main ProtoOcc map/occ-aligned setup.
# The main setup keeps both tasks on [-40, 40] / 0.4m for cleaner mutual
# guidance. This config is for fair comparison against BEVFusion-style map
# numbers and MAESTRO's stated feature canvas.
...
# Keep the depth supervision config unchanged; only the depth bins are used by
# PointToMultiViewDepth / depth loss in this setup.
grid_config = {
    'x': [-40, 40, 0.4],
    'y': [-40, 40, 0.4],
    'z': [-1, 5.4, 6.4],
