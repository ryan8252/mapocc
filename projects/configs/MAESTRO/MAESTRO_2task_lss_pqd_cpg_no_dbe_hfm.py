...
# No-DBE hybrid: LSS shared feature -> PQD-style CPG -> MAESTRO TSFG.
# Map TSFG is 192ch. The map TSFG feature is lifted into OCC TSFG by HFM-style
# residual fusion before the ProtoOcc CNN3D + PQD occupancy head.
...
work_dir = './work_dirs/MAESTRO_2task_lss_pqd_cpg_no_dbe_hfm'
