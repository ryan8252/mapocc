...
# TWCC sbatch script for ProtoOcc + CNN map neck + Map-neck Query-TSFG.
# Usage:
#   sbatch train_multi_cnn_head_map_neck_query_tsfg.sh


#SBATCH -J map_query_tsfg                         # 任務名稱
...
CONFIG="projects/configs/ProtoOcc/ProtoOcc_multi_cnn_head_map_neck_query_tsfg.py"
WORK_DIR="${PROTOOCC_DIR}/work_dirs/ProtoOcc_multi_cnn_head_map_neck_query_tsfg"
