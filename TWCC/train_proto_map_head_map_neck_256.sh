...
# TWCC sbatch script for ProtoOcc + prototype-based map head + 256-ch map BEV neck.
# Usage:
#   sbatch train_proto_map_head_map_neck_256.sh


#SBATCH -J mapocc_proto_map_head_map_neck_256        # 任務名稱
...
CONFIG="projects/configs/ProtoOcc/ProtoOcc_proto_map_head_map_neck_256.py"
WORK_DIR="${PROTOOCC_DIR}/work_dirs/ProtoOcc_proto_map_head_map_neck_256"
