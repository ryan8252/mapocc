...
# TWCC sbatch script for ProtoOcc + CNN map neck + CFV Prototype-TSFG V2.
# Usage:
#   sbatch train_multi_cnn_head_map_neck_cfv_proto_tsfg.sh


#SBATCH -J cfv_proto_tsfg                         # 任務名稱
...
CONFIG="projects/configs/ProtoOcc/ProtoOcc_multi_cnn_head_map_neck_cfv_proto_tsfg.py"
WORK_DIR="${PROTOOCC_DIR}/work_dirs/ProtoOcc_multi_cnn_head_map_neck_cfv_proto_tsfg"
