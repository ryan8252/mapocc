...
# TWCC sbatch script for ProtoOcc + CNN BEVSegHead + 128-channel map neck + V3 dynamic overlay balancing
# Usage:
#   sbatch train_multi_cnn_head_map_neck_overlay_dynamic.sh


#SBATCH -J cnn_map_neck_overlay_dyn       # 任務名稱
...
CONFIG="projects/configs/ProtoOcc/ProtoOcc_multi_cnn_head_map_neck_overlay_dynamic.py"
WORK_DIR="${PROTOOCC_DIR}/work_dirs/ProtoOcc_multi_cnn_head_map_neck_overlay_dynamic_2"
