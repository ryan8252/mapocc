...
# TWCC sbatch script for TGDE 01+02:
# HeightTaskGate + MapTopologyEncoder cat-Z parity.
# Usage:
#   sbatch train_multi_cnn_head_map_neck_tgde_htg_mte_catz.sh


#SBATCH -J tgde_htg_mte_catz              # 任務名稱
...
#SBATCH --mem=192G                        # 申請 192GB 系統記憶體
...
CONFIG="projects/configs/ProtoOcc/ProtoOcc_multi_cnn_head_map_neck_tgde_htg_mte_catz.py"
WORK_DIR="${PROTOOCC_DIR}/work_dirs/ProtoOcc_multi_cnn_head_map_neck_tgde_htg_mte_catz"
PRETRAIN_CKPT="${PROTOOCC_DIR}/ckpts/bevdet-r50-4d-depth-cbgs_depthnet_modify.pth"
GPUS=4
SAMPLES_PER_GPU=4
WORKERS_PER_GPU=1

# Keep the exact weight4 baseline optimization protocol:
# 4 GPUs * 4 samples/GPU, LR = 2e-4.
LR=2e-4
