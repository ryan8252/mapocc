...
# TWCC sbatch script for ProtoOcc + CNN BEVSegHead + 128-channel map neck + VAMI Stage 1
# Usage:
#   sbatch train_multi_cnn_head_map_neck_vami.sh


#SBATCH -J cnn_map_neck_vami              # 任務名稱
...
CONFIG="projects/configs/ProtoOcc/ProtoOcc_multi_cnn_head_map_neck_vami.py"
WORK_DIR="${PROTOOCC_DIR}/work_dirs/ProtoOcc_multi_cnn_head_map_neck_vami"
