...
# TWCC sbatch script for ProtoOcc + ProtoMapHeadV2 + 128-channel map neck.
# Usage:
#   sbatch train_proto_map_head_v2_map_neck.sh


#SBATCH -J proto_map_v2_neck                     # 任務名稱
...
CONFIG="projects/configs/ProtoOcc/ProtoOcc_proto_map_head_v2_map_neck.py"
WORK_DIR="${PROTOOCC_DIR}/work_dirs/ProtoOcc_proto_map_head_v2_map_neck"
PRETRAIN_CKPT="${PROTOOCC_DIR}/ckpts/bevdet-r50-4d-depth-cbgs_depthnet_modify.pth"
GPUS=4
SAMPLES_PER_GPU=4
WORKERS_PER_GPU=1

# Keep the same global batch/LR as the strong 128ch map-neck baseline:
# 4 GPUs * 4 samples/GPU = 16, LR = 2e-4.
LR=2e-4
