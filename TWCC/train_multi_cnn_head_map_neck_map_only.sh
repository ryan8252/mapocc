...
# TWCC sbatch script for the clean map-only upper-bound experiment.
# Usage:
#   sbatch train_multi_cnn_head_map_neck_map_only.sh


#SBATCH -J map_only_cnn_map_neck                 # 任務名稱
...
CONFIG="projects/configs/ProtoOcc/ProtoOcc_multi_cnn_head_map_neck_map_only.py"
WORK_DIR="${PROTOOCC_DIR}/work_dirs/ProtoOcc_multi_cnn_head_map_neck_map_only"
PRETRAIN_CKPT="${PROTOOCC_DIR}/ckpts/bevdet-r50-4d-depth-cbgs_depthnet_modify.pth"
GPUS=4
SAMPLES_PER_GPU=4
WORKERS_PER_GPU=1

# Keep the same global batch and LR as the 4-GPU CNN map-neck baseline.
LR=2e-4
