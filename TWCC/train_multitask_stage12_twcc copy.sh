...
# TWCC sbatch script for unimapocc / ProtoOcc multitask stage 1+2
# Usage:
#   sbatch train_multitask_stage12_twcc.sh


#SBATCH -J unimapocc_s12                    # 任務名稱 (隨便取)
...
PROTOOCC_DIR="/home/u2336262/Desktop/artc_2026/unimapocc/ProtoOcc"

CONFIG="projects/configs/ProtoOcc/ProtoOcc_multitask_stage12_direct.py"
WORK_DIR="${PROTOOCC_DIR}/work_dirs/ProtoOcc_multitask_stage12_direct"
