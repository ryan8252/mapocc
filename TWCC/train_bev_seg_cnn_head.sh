...
# TWCC sbatch script for mapocc / bev cnn head
# Usage:
#   sbatch train_multitask_stage12_twcc.sh


#SBATCH -J mapocc_cnn_head                    # 任務名稱 (隨便取)
...
CONFIG="projects/configs/ProtoOcc/ProtoOcc_bevfusion_mapgt_protoocc_range.py"
WORK_DIR="${PROTOOCC_DIR}/work_dirs/ProtoOcc_bevfusion_mapgt_protoocc_range"
