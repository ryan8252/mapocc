#!/usr/bin/env python3
"""Train, evaluate, and record the FPN-ASPP + focal-Dice weighted smoke run."""
...
CONFIG = (
    ...
    "ProtoOcc_multi_cnn_head_map_neck_fpn_lateral_aspp_focal_dice_weighted.py"
)
WORK_DIR = (
    "work_dirs/"
    "smoke_ProtoOcc_multi_cnn_head_map_neck_fpn_lateral_aspp_"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the FPN-ASPP + focal-Dice weighted 1quarter smoke train/eval."
    )
    parser.add_argument("--conda-env", default="mapocc")
    parser.add_argument("--train-port", type=int, default=29615)
    parser.add_argument("--eval-port", type=int, default=29616)
