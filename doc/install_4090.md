...
conda create --name ProtoOcc python=3.8 -y
...
# 3. 安裝系統編譯依賴與設定 CUDA 11.8 環境變數
sudo apt-get update
sudo apt-get install python3-dev libevent-dev build-essential ninja-build -y
...
# 5. 使用 mim 從原始碼編譯 OpenMMLab 家族 (升級至 1.x 最終穩定版)
pip install -U openmim
mim install mmcv-full==1.7.2
pip install mmdet==2.28.2
pip install mmsegmentation==0.30.0

# 6. 安裝其他專案相依套件 (維持你原本指定的穩定版本)
...
```
1.   
File "/home/robot/Desktop/Ryan/unimapocc/ProtoOcc/mmdetection3d/mmdet3d/__init__.py", line 26, in <module>
    assert (mmcv_version >= digit_version(mmcv_minimum_version)
AssertionError: MMCV==1.7.2 is used but incompatible. Please install mmcv>=1.5.2, <=1.7.0.

solution: 
in ProtoOcc/mmdetection3d/mmdet3d/__init__.py
chage mmcv_maximum_version = '1.7.0' to mmcv_maximum_version = '1.8.0' 
```
